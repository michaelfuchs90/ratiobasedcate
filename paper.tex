...
cannot be ruled out, the S/T log-scale DR learners introduced here are clearly
superior, confirming the importance of classical double robustness in such
settings.
...
We evaluate twelve learners: four plug-in methods (S, T, Q, Q-Simple) and eight doubly robust variants (DR-T, DR-T log,
DR-S, DR-S log, DR-Q, DR-Q log, DR-Q-Simple, and DR-Q-Simple log). Q-Simple and
...
\paragraph{Datasets.}
We select datasets to cover a range of sample sizes ($n = 1.6$k--$687$k),
...
with $e=0.5$. $^\dagger$10\% random subsample for computational feasibility
(full dataset: 13.9M rows).}
...
\hline
Criteo$^\dagger$ \citep{diemert2018}    &   140k   &  4.7\% & 85.0\% & E-commerce \\
...
different winners (DR-S on two datasets, DR-Q-Simple, DR-Q, T-Learner,
Q-Learner, and DR-T log). In the cross-dataset ratio-to-best summary
...
value, but the Q-Learner is markedly more stable across datasets:
its worst-case ratio is $R_{\min}^Q = 0.40$, compared to $0.30$ for
the S-Learner (which drops to that level on Lenta).
...
(Q: $0.76$, S: $0.76$), while the best DR variant (DR-Q-Simple)
reaches $0.68$ and every other DR variant falls below $0.64$. On the four RCTs where a DR variant is the outright winner
...
($1.11$) and DR-S ($1.19$). DR learners on direct scale remain
...
\hline
S
 & 0.435 & 0.371 & 0.334 & 1.424 & 0.073 & 0.027 & 0.087 & \textbf{0.393} & 0.298 \\
...
T
 & 0.321 & 0.181 & 0.263 & \textbf{1.533} & 0.055 & 0.025 & 0.076 & 0.351 & 0.276 \\
...
Q
 & 0.219 & 0.507 & 0.454 & 1.228 & 0.030 & \textbf{0.089} & 0.086 & 0.373 & 0.399 \\
...
Q-Simple
 & 0.215 & 0.516 & 0.427 & 1.236 & 0.025 & 0.002 & 0.083 & 0.358 & 0.022 \\
...
\hline
DR-Q
 & 0.356 & 0.580 & \textbf{0.508} & 1.184 & 0.070 & $-$0.017 & 0.013 & 0.385 & $-$0.195 \\
...
DR-Q log
 & 0.268 & 0.514 & 0.193 & 1.263 & 0.058 & 0.014 & 0.085 & 0.342 & 0.160 \\
...
DR-Q-Simple
 & 0.336 & \textbf{0.615} & 0.461 & 1.145 & 0.043 & $-$0.003 & 0.080 & 0.383 & $-$0.035 \\
...
DR-Q-Simple log
 & 0.243 & 0.600 & 0.449 & 1.229 & 0.026 & 0.006 & 0.073 & 0.375 & 0.066 \\
...
DR-T
 & 0.438 & 0.010 & 0.331 & 1.236 & 0.075 & 0.016 & 0.003 & 0.301 & 0.017 \\
...
DR-T log
 & 0.319 & 0.109 & 0.157 & 1.253 & 0.059 & 0.016 & \textbf{0.092} & 0.286 & 0.177 \\
...
DR-S
 & \textbf{0.473} & 0.321 & 0.343 & 1.195 & \textbf{0.076} & 0.004 & $-$0.002 & 0.344 & $-$0.016 \\
...
\hline
S
 & \textbf{1.224} & 2.316 & 1.110 & 1.076 & \textbf{1.024} & \textbf{1.113} & 1.397 & \textbf{1.323} & 1.084 \\
...
T
 & 1.490 & 3.295 & 1.211 & 1.103 & 1.057 & 1.322 & 1.961 & 1.634 & 1.543 \\
...
Q
 & 1.507 & 3.958 & 1.130 & 1.125 & 1.078 & 1.290 & 2.137 & 1.746 & 1.853 \\
...
Q-Simple
 & 1.514 & 3.979 & 1.153 & 1.130 & 1.075 & 1.387 & 2.148 & 1.770 & 1.863 \\
...
\hline
DR-Q
 & 1.525 & 4.660 & 1.142 & 1.077 & 1.046 & 1.465 & 1.757 & 1.810 & 2.182 \\
...
DR-Q log
 & 1.890 & 3.240 & 1.157 & 1.098 & 1.054 & 1.422 & 1.827 & 1.670 & 1.545 \\
...
DR-Q-Simple
 & 1.613 & 4.147 & 1.251 & 1.087 & 1.091 & 1.849 & 1.536 & 1.796 & 1.942 \\
...
DR-Q-Simple log
 & 1.621 & 4.903 & 1.184 & 1.115 & 1.074 & 1.398 & 2.328 & 1.946 & 2.296 \\
...
DR-T
 & 1.512 & 7.541 & 1.115 & \textbf{1.048} & 1.047 & 1.487 & 1.594 & 2.192 & 3.531 \\
...
DR-T log
 & 1.890 & 2.784 & 1.234 & 1.092 & 1.055 & 1.457 & 1.583 & 1.585 & 1.545 \\
...
DR-S
 & 1.373 & 3.568 & \textbf{1.101} & 1.064 & 1.045 & 1.517 & 1.573 & 1.606 & 1.671 \\
...
DR-S log
 & 1.719 & \textbf{2.136} & 1.175 & 1.098 & 1.053 & 1.337 & \textbf{1.363} & 1.411 & 1.405 \\
 & \scriptsize(0.010) & \scriptsize(0.041) & \scriptsize(0.004) & \scriptsize(0.002) & \scriptsize(0.001) & \scriptsize(0.005) & \scriptsize(0.011) & & \\
\hline
\textit{Dataset mean} & 1.573 & 3.877 & 1.164 & 1.093 & 1.058 & 1.420 & 1.767 & & \\
\hline
\end{tabular}
\end{table}
